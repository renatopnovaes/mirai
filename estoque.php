        ...
        <form action="inserir_estoque.php" method="post">
            ...
            <div class="row mt-3">
                ...
                <div class="col">
                    ...
                    <select name="origem" required id="origem" class="form-select" onchange="atualizarListas(this.value, 'destino');" required>
                ...
                <div class="col">
                    ...
                    <select name="destino" required id="destino" class="form-select" onchange="atualizarListas(this.value, 'origem');" required>
                        <option disabled selected value="">Escolha a sua Origem</option>
                        <?php
