function atualizarListas(valor, listaAlvoId) {
  ...
  origemSelect.addEventListener("change", function(event) {
    atualizarListas(event.target.value, "destino");
  });
  
  destinoSelect.addEventListener("change", function(event) {
    atualizarListas(event.target.value, "origem");
  });
